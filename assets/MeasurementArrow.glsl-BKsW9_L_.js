import{Dl as e,Il as t,Ol as n,Tl as r,Ys as i,bg as a}from"./index-CT02vMCE.js";function o(o){let s=new r,{vertex:c,fragment:l}=s;i(c,o),c.uniforms.add(new e(`width`,(e=>e.width))),s.attributes.add(a.POSITION,`vec3`),s.attributes.add(a.NORMAL,`vec3`),s.attributes.add(a.UV0,`vec2`),s.attributes.add(a.LENGTH,`float`),s.varyings.add(`vtc`,`vec2`),s.varyings.add(`vlength`,`float`),s.varyings.add(`vradius`,`float`),c.code.add(t`void main(void) {
