import{Dl as e,Il as t,Ol as n,Tl as r,Ys as i,bg as a}from"./index-BgI8gEq1.js";function o(o){let s=new r,{vertex:c,fragment:l,attributes:u,varyings:d}=s;return i(c,o),u.add(a.POSITION,`vec3`),u.add(a.UV0,`vec2`),d.add(`vUV`,`vec2`),c.code.add(t`void main(void) {
vUV = uv0;
