const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ImageMaterial.glsl-CXFVE2e9.js","assets/index-BKAXQA0Y.js","assets/index-C9qWRVJ5.css"])))=>i.map(i=>d[i]);
import{$c as e,$s as t,Dl as n,Do as r,Eo as i,Fc as a,Gs as o,Il as s,Jo as c,Js as l,Ko as u,Mg as d,Or as f,Pc as p,Qc as m,Qo as h,Tc as g,Tl as _,To as v,Xc as y,Xo as b,Ys as x,_l as S,bg as C,dc as w,dr as T,ec as E,el as D,fc as O,fs as k,il as A,is as j,jg as M,ls as N,nc as P,nl as F,ok as I,ol as L,os as R,qo as ee,rh as z,rk as B,rl as V,ts as H,wl as U,wo as W,xl as G}from"./index-BKAXQA0Y.js";function K(e){let t=new _,{vertex:r,fragment:i}=t;return x(r,e),t.include(o,e),t.attributes.add(C.POSITION,`vec3`),t.attributes.add(C.UV0,`vec2`),e.perspectiveInterpolation&&t.attributes.add(C.PERSPECTIVEDIVIDE,`float`),t.varyings.add(`vpos`,`vec3`),e.multipassEnabled&&t.varyings.add(`depth`,`float`),r.code.add(s`
    void main(void) {
      vpos = position;
